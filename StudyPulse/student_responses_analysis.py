...
# ✅ Robust NLTK tokenizer function
def safe_tokenize(text):
    """Safely tokenize text with fallback methods"""
    try:
...
def analyze_student_responses(text_data, column_name, sentiment_analyzer=None):
    ...
    try:
        ...
        try:
            ...
            # Tokenize using safe tokenizer
            tokens = safe_tokenize(all_text)
            ...
            try:
                ...
                for cluster_num in range(num_clusters):
                    ...
                    if cluster_indices:
                        ...
                        cluster_tokens = safe_tokenize(cluster_text)
